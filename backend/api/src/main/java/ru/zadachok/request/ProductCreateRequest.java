...
public class ProductCreateRequest {
    ...
    @JsonProperty("customerid")  // Входящее поле в JSON будет "customerid" (id участника кто будет покупать)
    @NotBlank
    private Integer customerId;
    @JsonProperty("shopid")  // Входящее поле в JSON будет "shopid" (id магазина куда добавить продукт)
    @NotBlank
